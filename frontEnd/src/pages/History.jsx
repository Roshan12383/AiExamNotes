...
function History(){
    ...
    return(
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
            ...
            className="mb-10 rounded-2xl  bg-black/80 backdrop-blur-xl border border-white/10 px-8
            py-6 items-start flex justify-between md:items-center gap-4 flex-wrap
              ...
              <div className="flex items-center gap-4 flex-wrap">
               {!isSidebarOpen && <button onClick={()=>setIsSidebarOpen(true)}
                className="lg:hidden text-white text-2xl "><GiHamburgerMenu /></button>}
                 ...
                 <button className="flex items-center gap-2 px-4 px-2 rounded-full bg-white/10 border
                   border-white/20 text-white text-sm "  onClick={()=>navigate("/pricing")}>
                ...
                <AnimatePresence>
                    ...
                    >
                        ...
                        <div className="mb-4 space-y-1">
                            ...
                            <h2 className="mb-4 text-lg font-bold bg-gradient-to-br from-white via-gray-300
                                ...
                                :"bg-white/5 border-white/10 hover:bg-white/10"
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-2 text-xs">
                                           ...
                                           <span className="px-2 py-0.5 rounded-full bg-indigo-500/20
                                            ...
                                            {t.examType && 
                                           <span className="px-2 py-0.5 rounded-full bg-purple-500/20
