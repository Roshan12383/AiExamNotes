    ...
    return(
        <div className="min-h-screen overflow-hidden bg-white text-black">
           ...
           <section className="max-w-7xl mx-auto px-8 pt-32 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
               <div>
                <motion.div 
                   ...
                   <motion.h1 className="text-5xl lg:text-6xl font-extrabold leading-tight bg-gradient-to-br
                   ...
                   <motion.p  whileHover={{y:-2}}
                     className="mt-6 max-w-xl text-lg bg-gradient-to-br from-gray-700 via-gray-500/80
                       ...
                       Generate exam-focused notes, project documentation, flow diagrams and revision-ready 
           ...
           <section className="max-w-6xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-4 gap-10">
             <Feature  icon="📘" title="Exam Notes" des="High-yeild exam-oriented notes with 
                revision points."/>

            <Feature  icon="📂" title="Project Notes" des="Well-structured content for assignments
              and projects."/>
