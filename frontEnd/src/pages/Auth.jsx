        ...
        <div className="min-h-screen overflow-hidden bg-white text-black px-8">
            ...
            <motion.header 
               ...
               <h1 className="text-2xl font-bold bg-linear-to-r from-white via-gray-300 to-white 
                    bg-clip-text text-transparent">ExamNote AI</h1>

                <p className="text-sm text-gray-300 mt-1">AI-powered exam-oriented notes & revision </p>
            </motion.header>

             
            <main className=" max-w-7xl mx-auto grid grid-cols-1 py-10 lg:grid-cols-2 gap-20 items-center">
                ...
                <motion.div
                 ...
                 transition={{duration:0.7}}>
                    ...
                    className="mt-10 px-10 py-3 rounded-xl flex items-center gap-3 
                     bg-gradient-to-br from-black/90 via-black/60 to-black/90 border border-white/10 
                    ...
                    >You get <span className="font-semibold">50 FREE credits</span> to create exam 
                    notes, project notes, charts, graphs and download clean pdf - instantly using AI.
                    </p>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <Feature icon="🎁" title="50 Free credits" des="Start with 50 credits to generates notes 
                       without paying"/>
                    <Feature icon="📘" title="Exam Notes" des="High-yield, revision-ready exam oriented notes"/>
                    <Feature icon="📂" title="Project Notes" des="Will-structured documentation for 
...
function Feature({icon,title,des}){
    return(
        <motion.div 
          whileHover={{y:-12,rotateX:-8,rotateY:8,scale:1.005}}
          transition={{type:"spring",stiffness:200,damping:18}}
