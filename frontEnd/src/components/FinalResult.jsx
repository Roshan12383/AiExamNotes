...
function FinalResult({result}){
    ...
    if(!result || !result.subTopics || !result.questions || !result.questions.short || 
        ...
        <div className="mt-6 p-3 space-y-10 bg-white">
             <div className="flex flex-col md:flex-row md:items-center md:justify-between
               gap-4">
                ...
                <h2 className="text-3xl font-bold bg-gradient-to-br from-indigo-600 to-purple-600
                ...
                <div className="flex gap-3">
                    <button   onClick={()=>setQuickRevision(!quickRevision)}
                     className={`px-4 py-2 rounded-lg text-sm font-medium transition
                        ${quickRevision ? "bg-green-600 text-white" : 
            ...
            { !quickRevision && <section>
             ...
             {quickRevision && 
               <section className='rounded-xl bg-gradient-to-br from-green-100 to-green-50 border
               ...
               { result.diagram?.data && 
                   (<section>
                      ...
                      <p className='mt-3 text-xs text-gray-500 italic'>
                       ℹ️ If you need this diagram for future reference or revision, you can save it 
               ...
               {result.charts?.length>0 && (
                   <section>
                      ...
                      <RechartSetup charts={result.charts}/>
                       <p className='mt-3 text-xs text-gray-500 italic'>
                       ℹ️ If you need this Chart for future reference or revision, you can save it 
                        by taking a screenshot.
                      </p>
                   </section>
               )}
...
function SectionHeader({icon,title,color}){
  ...
  return(
     <div className={`mb-4 px-4 py-2 rounded-lg bg-gradient-to-br ${colors[color]} font-semibold
